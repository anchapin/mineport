...
import { createTempDirectory, cleanupTempDirectory, verifyAddonStructure } from '../helpers';
import { AddonPackager } from '../../../src/modules/packaging/AddonPackager';
import { AddonValidator } from '../../../src/modules/packaging/AddonValidator';
...
import { LicenseEmbedder } from '../../../src/modules/configuration/LicenseEmbedder';
import fs from 'fs';
...
describe('Packaging Pipeline Integration', () => {
  ...
  it('should generate a conversion report', async () => {
    ...
    fs.writeFileSync(path.join(outputDir, 'conversion-report.json'), JSON.stringify(report.json, null, 2));
