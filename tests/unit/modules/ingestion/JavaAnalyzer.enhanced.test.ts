...
describe('JavaAnalyzer - Enhanced Tests', () => {
  ...
  describe('Multi-Strategy Registry Extraction', () => {
    ...
    it('should extract registry names from JSON files', async () => {
      ...
      zip.addFile('assets/testmod/blockstates/custom_block.json', Buffer.from(JSON.stringify(blockstatesJson)));
      zip.addFile('assets/testmod/models/block/custom_block.json', Buffer.from(JSON.stringify(modelsJson)));
    ...
    it('should extract registry names from model files', async () => {
      ...
      zip.addFile('assets/testmod/models/item/special_item.json', Buffer.from(JSON.stringify(itemModel)));
      zip.addFile('assets/testmod/models/block/special_block.json', Buffer.from(JSON.stringify(blockModel)));
    ...
    it('should combine results from all strategies', async () => {
      ...
      const classContent = 'Registry.register(Registry.BLOCK, new Identifier("testmod", "class_block"), new Block())';
      ...
      zip.addFile('assets/testmod/lang/en_us.json', Buffer.from(JSON.stringify(langData)));
      zip.addFile('assets/testmod/models/block/model_block.json', Buffer.from(JSON.stringify(modelData)));
  ...
  describe('Texture Path Detection', () => {
    ...
    it('should handle nested texture directories', async () => {
      ...
      zip.addFile('assets/testmod/textures/block/variants/stone_variant.png', Buffer.from('fake png'));
      ...
      expect(result.texturePaths).toContain('assets/testmod/textures/block/variants/stone_variant.png');
