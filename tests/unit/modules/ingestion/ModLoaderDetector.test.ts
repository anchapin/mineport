...
import { ModLoaderDetector, ModLoaderType, DetectionResult } from '../../../../src/modules/ingestion/ModLoaderDetector';
...
describe('ModLoaderDetector', () => {
  ...
  beforeEach(() => {
    ...
    mockForgeModFiles = {
      '/tmp/mod/META-INF/MANIFEST.MF': 'Manifest-Version: 1.0\nModId: test-forge-mod\nVersion: 1.0.0',
      '/tmp/mod/META-INF/mods.toml': 'modId="test-forge-mod"\nversion="1.0.0"\ndisplayName="Test Forge Mod"',
    ...
    mockFabricModFiles = {
      ...
      '/tmp/mod/fabric.mod.json': '{"id": "test-fabric-mod", "version": "1.0.0", "name": "Test Fabric Mod"}',
