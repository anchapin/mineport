...
import { ParticleMapper } from '../../../../src/modules/assets/ParticleMapper.js';
  ...
  beforeEach(() => {
    ...
    mockTextureConverter = {
      convertTextures: vi.fn().mockResolvedValue({
        ...
        atlases: [],
        conversionNotes: [
          { type: 'info', message: 'Texture converted', texturePath: 'texture1.png' },
        ],
      }),
    ...
    mockParticleMapper = {
      convertParticles: vi.fn().mockResolvedValue({
        ...
        conversionNotes: [
          { type: 'info', message: 'Particle converted', particleName: 'particle1' },
        ],
      }),
