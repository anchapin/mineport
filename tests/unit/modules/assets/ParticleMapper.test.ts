...
} from '../../../../src/modules/assets/ParticleMapper';
...
describe('ParticleMapper', () => {
  ...
  describe('generateBedrockParticleData', () => {
    it('should generate correct Bedrock particle data structure', async () => {
      ...
      expect(bedrockData.particle_effect.components['minecraft:emitter_rate_instant']).toBeDefined();
      expect(bedrockData.particle_effect.components['minecraft:emitter_rate_instant'].num_particles).toBe(5);
    });
  });
});