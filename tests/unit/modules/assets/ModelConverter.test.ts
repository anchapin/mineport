...
import { 
  ...
  JavaModelFile, 
  BedrockModelFile
} from '../../../../src/modules/assets/ModelConverter';
...
describe('ModelConverter', () => {
  ...
  describe('convertModels', () => {
    it('should convert all models successfully', async () => {
      ...
      expect(result.convertedModels[0].path).toContain('models/blocks/examplemod_example_block.geo.json');
      expect(result.convertedModels[1].path).toContain('models/items/examplemod_example_item.geo.json');
      expect(result.convertedModels[2].path).toContain('models/entity/examplemod_example_entity.geo.json');
    });
  ...
  describe('organizeModels', () => {
    ...
    it('should create material definition files when needed', async () => {
      ...
      const materialFileCall = writeFileCalls.find(call => 
