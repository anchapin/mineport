  ...
  describe('transpile', () => {
    it('should transpile simple class declaration', async () => {
      const mockMMIR: MMIRRepresentation = {
        ...
        metadata: {
          ...
          complexity: { cyclomaticComplexity: 1, cognitiveComplexity: 1, linesOfCode: 3, nestingDepth: 1 },
          imports: [],
          classes: [],
          methods: []
        },
    ...
    it('should transpile control flow structures', async () => {
      const mockMMIR: MMIRRepresentation = {
        ...
        metadata: {
          ...
          complexity: { cyclomaticComplexity: 5, cognitiveComplexity: 5, linesOfCode: 10, nestingDepth: 2 },
          imports: [],
          classes: [],
          methods: []
        },
    ...
    it('should handle assignments and field declarations', async () => {
      const mockMMIR: MMIRRepresentation = {
        ...
        metadata: {
          ...
          complexity: { cyclomaticComplexity: 1, cognitiveComplexity: 1, linesOfCode: 2, nestingDepth: 0 },
          imports: [],
          classes: [],
          methods: []
        },
    ...
    it('should handle nested AST structures', async () => {
      const mockMMIR: MMIRRepresentation = {
        ...
        metadata: {
          ...
          complexity: { cyclomaticComplexity: 3, cognitiveComplexity: 4, linesOfCode: 8, nestingDepth: 3 },
          imports: [],
          classes: [],
          methods: []
        },
    ...
    it('should generate warnings for low confidence transpilation', async () => {
      const mockMMIR: MMIRRepresentation = {
        ...
        metadata: {
          ...
          complexity: { cyclomaticComplexity: 1, cognitiveComplexity: 1, linesOfCode: 16, nestingDepth: 1 },
          imports: [],
          classes: [],
          methods: []
        },
    ...
    it('should calculate confidence based on transpilation success', async () => {
      ...
      const lowConfidenceMockMMIR: MMIRRepresentation = {
        ...
        metadata: {
          originalLinesOfCode: 1,
          complexity: { cyclomaticComplexity: 10, cognitiveComplexity: 10, linesOfCode: 1, nestingDepth: 0 },
          imports: [],
          classes: [],
          methods: []
        },
    ...
    it('should handle empty AST', async () => {
      const emptyMMIR: MMIRRepresentation = {
        ...
        metadata: {
          ...
          complexity: { cyclomaticComplexity: 1, cognitiveComplexity: 1, linesOfCode: 0, nestingDepth: 0 },
          imports: [],
          classes: [],
          methods: []
        },
