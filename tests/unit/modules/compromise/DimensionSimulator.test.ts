...
import { DimensionSimulator, DimensionProperties } from '../../../../src/modules/compromise/DimensionSimulator';
...
describe('DimensionSimulator', () => {
  ...
  it('should generate dimension simulation code', () => {
    const result = simulator.generateDimensionSimulation(testFeature, 'TestDimension', testProperties);
    ...
    expect(mockLogger.info).toHaveBeenCalledWith('Generating dimension simulation for: TestDimension');
  });
  ...
  it('should handle dimensions with no structures', () => {
    ...
    const result = simulator.generateDimensionSimulation(testFeature, 'TestDimension', propertiesWithoutStructures);
  ...
  it('should generate dimension boundary detection code', () => {
    ...
    expect(result.simulationCode).toContain(`const boundaryRadius = ${testProperties.boundaryRadius}`);
