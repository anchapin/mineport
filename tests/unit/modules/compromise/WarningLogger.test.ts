...
import { WarningLogger, WarningType, FeatureWarning } from '../../../../src/modules/compromise/WarningLogger';
...
describe('WarningLogger', () => {
  ...
  it('should generate console warning code', () => {
    ...
    expect(warningCode).toBe('console.warn("[RENDERING STUB] Test Feature: Advanced rendering not supported");');
  });
  ...
  it('should use different prefixes for different warning types', () => {
    const warningTypes: WarningType[] = ['rendering', 'dimension', 'ui', 'api', 'performance', 'other'];
