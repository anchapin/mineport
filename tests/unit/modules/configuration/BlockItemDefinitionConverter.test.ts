...
import { BlockItemDefinitionConverter, JavaRegistrationCode } from '../../../../src/modules/configuration/BlockItemDefinitionConverter';
...
describe('BlockItemDefinitionConverter', () => {
  ...
  describe('convertBlockDefinitions', () => {
    it('should convert Java block registrations to Bedrock block definitions', () => {
      ...
      const destroyTime = result[0]['minecraft:block'].components['minecraft:destructible_by_mining'].seconds_to_destroy;
  ...
  describe('convertItemDefinitions', () => {
    it('should convert Java item registrations to Bedrock item definitions', () => {
      ...
      expect(result[0]['minecraft:item'].components['minecraft:durability'].max_durability).toBe(100);
