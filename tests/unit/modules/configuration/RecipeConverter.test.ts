...
import { RecipeConverter, JavaRecipe, BedrockRecipe, RecipeConversionResult } from '../../../../src/modules/configuration/RecipeConverter';
...
describe('RecipeConverter', () => {
  ...
  describe('convertRecipes', () => {
    it('should convert shaped crafting recipes to Bedrock format', () => {
      ...
      expect(result.recipes[0]['minecraft:recipe_shaped']?.key['#'].item).toBe('minecraft:iron_ingot');
    });
    ...
    it('should convert shapeless crafting recipes to Bedrock format', () => {
      ...
      expect(result.recipes[0]['minecraft:recipe_shapeless']?.result.item).toBe('minecraft:light_blue_dye');
    });
    ...
    it('should convert furnace recipes to Bedrock format', () => {
      ...
      expect(result.recipes[0]['minecraft:recipe_furnace']?.output.item).toBe('minecraft:iron_ingot');
    });
    ...
    it('should convert stonecutting recipes to Bedrock format', () => {
      ...
      expect(result.recipes[0]['minecraft:recipe_furnace']?.output.item).toBe('minecraft:stone_bricks');
    });
    ...
    it('should convert smithing recipes to Bedrock format', () => {
      ...
      expect(result.recipes[0]['minecraft:recipe_brewing_mix']?.input.item).toBe('minecraft:diamond_chestplate');
      expect(result.recipes[0]['minecraft:recipe_brewing_mix']?.reagent.item).toBe('minecraft:netherite_ingot');
      expect(result.recipes[0]['minecraft:recipe_brewing_mix']?.output.item).toBe('minecraft:netherite_chestplate');
    });
    ...
    it('should handle tag usage in recipes', () => {
      ...
      expect(result.success).toBe(true);
      expect(result.recipes).toHaveLength(1);
      expect(result.conversionNotes.some(note => note.type === 'warning' && note.message.includes('tag'))).toBe(true);
    });
