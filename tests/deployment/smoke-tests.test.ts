...
describe('ModPorter-AI Deployment Smoke Tests', () => {
  ...
  describe('Health Check Endpoints', () => {
    ...
    it('should return ready status from /ready endpoint', async () => {
    ...
    it('should return alive status from /live endpoint', async () => {
  ...
  describe('Feature Flag Configuration', () => {
    it('should have valid feature flag configuration', async () => {
    ...
    it('should have ModPorter-AI features properly configured', async () => {
  ...
  describe('Security Features', () => {
    ...
    it('should have security scanning enabled', async () => {
      const response = await axios.get(`${BASE_URL}/health`);
  ...
  describe('Monitoring Integration', () => {
    ...
    it('should provide structured log output', async () => {
...
describe('ModPorter-AI Feature-Specific Smoke Tests', () => {
  ...
  describe('Rollback Capability', () => {
    it('should handle rollback mode correctly', async () => {
...
describe('Integration Validation', () => {
  ...
  describe('Configuration Validation', () => {
    it('should have valid environment configuration', async () => {
      const response = await axios.get(`${BASE_URL}/config/validate`);
      ...
      const failedChecks = response.data.checks.filter(
