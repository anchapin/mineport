...
import { BlockItemDefinitionConverter } from '../../src/modules/configuration/BlockItemDefinitionConverter.js';
import { RecipeConverter } from '../../src/modules/configuration/RecipeConverter.js';
import { JavaParser } from '../../src/modules/logic/JavaParser.js';
import { MMIRGenerator } from '../../src/modules/logic/MMIRGenerator.js';
import { ASTTranspiler } from '../../src/modules/logic/ASTTranspiler.js';
import { JavaScriptGenerator } from '../../src/modules/logic/JavaScriptGenerator.js';
...
async function runConversionBenchmark() {
  ...
  try {
    ...
    updateBenchmarkHistory(benchmarkSuite, path.join(resultsPath, 'benchmark-history.json'));
