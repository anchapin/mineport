...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  const handleCompromiseOptionChange = (strategyId: string, optionId: string, value: string | boolean | number) => {
    setCurrentPreferences(prev => ({
      ...prev,
      compromiseStrategies: prev.compromiseStrategies.map(strategy => 
        strategy.id === strategyId 
  ...
  const handleConversionOptionChange = (option: keyof UserPreferences['conversionOptions'], value: any) => {
    setCurrentPreferences(prev => ({
      ...prev,
      conversionOptions: {
              ...
              <div key={option.id} className="option-item">
                ...
                {option.type === 'boolean' && (
                  <input 
                    ...
                    onChange={(e) => handleCompromiseOptionChange(
                      strategy.id, 
                      option.id, 
                      e.target.checked
                    )}
            ...
            <div className="setting-group">
              ...
              <div className="option-item">
                ...
                <select 
                  ...
                  onChange={(e) => handleConversionOptionChange('targetMinecraftVersion', e.target.value)}
                >
              ...
              <div className="option-item">
                ...
                <input 
                  ...
                  onChange={(e) => handleConversionOptionChange('includeComments', e.target.checked)}
                />
              </div>
            </div>
          </div>
          ...
          <div className="compromise-settings">
            <div className="compromise-explanation">
              ...
              <p>
                ...
                Enable or disable specific strategies and configure their options below.
              </p>
            </div>
            ...
            <div className="setting-group">
              ...
              <div className="option-item">
                ...
                <input 
                  ...
                  onChange={(e) => handleConversionOptionChange('generateDebugInfo', e.target.checked)}
                />
              </div>
