...
import { ConversionAPIServiceImpl, APIError } from '../ConversionAPIServiceImpl.js';
...
describe('ConversionAPIServiceImpl', () => {
  ...
  describe('startConversion', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(service.startConversion({ modFile: file })).rejects.toThrow(
        new APIError('Invalid file format', 400, 'INVALID_FILE')
      );
    });
