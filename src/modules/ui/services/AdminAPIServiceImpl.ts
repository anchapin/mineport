...
import { AdminAPIService, AdminJobFilter, JobStatistics, SystemResourceUsage } from './AdminAPIService';
import { ConversionJob, JobStatus } from '../../../types/services';
import { APIError } from './ConversionAPIServiceImpl';
...
export class AdminAPIServiceImpl implements AdminAPIService {
  ...
  public async getJobStatistics(): Promise<JobStatistics> {
    ...
    try {
      const response = await this.fetchWithTimeout(
        `${this.baseUrl}/api/admin/jobs/statistics`,
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
  ...
  public async getSystemResourceUsage(): Promise<SystemResourceUsage> {
    ...
    try {
      const response = await this.fetchWithTimeout(
        `${this.baseUrl}/api/admin/system/resources`,
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
