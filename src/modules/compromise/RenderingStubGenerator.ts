    ...
    return [
      {
        ...
        detectionRegex: /extends\s+ModelRenderer|implements\s+IModelRender|@SubscribeEvent\s+.*RenderWorldLastEvent|@SubscribeEvent\s+.*RenderLivingEvent/,
        category: 'model-rendering'
      },
      {
        id: 'shader-program',
        name: 'Custom Shader Program',
        detectionRegex: /ShaderManager|ShaderProgram|glsl|GL20\.GL_FRAGMENT_SHADER|GL20\.GL_VERTEX_SHADER|glUniform|glAttachShader/,
        category: 'shaders'
      },
      {
        id: 'particle-effects',
        name: 'Custom Particle Effects',
        detectionRegex: /extends\s+Particle|ParticleManager|IParticleFactory|createParticle|spawnParticle/,
        category: 'particles'
      },
      {
        id: 'block-model',
        name: 'Custom Block Model',
        detectionRegex: /IBakedModel|IBlockModel|ModelBakery|BlockModelRenderer|ModelResourceLocation/,
        category: 'block-models'
      },
      {
        id: 'entity-renderer',
        name: 'Custom Entity Renderer',
        detectionRegex: /extends\s+EntityRenderer|implements\s+IRenderFactory|RenderLiving|RenderManager\.register/,
        category: 'entity-rendering'
      },
      {
        id: 'gui-rendering',
        name: 'Custom GUI Rendering',
        detectionRegex: /drawTexturedModalRect|drawGradientRect|drawRect|drawString|RenderHelper|GlStateManager|GL11\./,
        category: 'gui'
      },
      {
        id: 'item-model',
        name: 'Custom Item Model',
        detectionRegex: /ItemModelMesher|ItemOverrideList|ModelLoader|ModelBakery|ItemCameraTransforms/,
