...
class PipelineValidator {
    ...
    async generateValidationReport() {
        ...
        this.results.summary = {
            ...
            integrationTestsPassed: Object.values(this.results.integrationTests)
                .filter(test => test.status === 'passed').length,
            performanceMetricsCollected: Object.keys(this.results.performanceMetrics).length,
            failureScenariosValidated: Object.values(this.results.failureScenarios)
                .filter(test => test.status === 'validated').length,
